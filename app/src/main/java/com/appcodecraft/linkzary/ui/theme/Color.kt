...
// Dark Theme Colors
val DarkPrimary = Color(0xFF818CF8) // Lighter indigo for dark mode
val DarkOnPrimary = Color(0xFF1E1B4B)
val DarkPrimaryContainer = Color(0xFF3730A3)
val DarkOnPrimaryContainer = Color(0xFFE0E7FF)

val DarkSecondary = Color(0xFF8B5CF6) // Purple accent
val DarkOnSecondary = Color(0xFF2D1B69)
...
val DarkTertiaryContainer = Color(0xFF0891B2)
...
val PurpleGrey80 = DarkOnSurfaceVariant
val Pink80 = DarkTertiary

val Purple40 = Primary
val PurpleGrey40 = OnSurfaceVariant
val Pink40 = Tertiary