...
Security fixes are applied to the latest released version of Linkzary.
...
We take security seriously. If you discover a vulnerability in Linkzary, **please do not open a public GitHub issue**.

Instead, report it **privately** using one of these options:

1. **GitHub private vulnerability reporting** (preferred): go to the
   [Security tab](https://github.com/ZaryabKhan/Linkzary/security/advisories/new)
   and choose **"Report a vulnerability"**.
2. **Email**: contact the maintainer at **appcodecraft@gmail.com** with the subject
   `[Linkzary Security] <short summary>`.
...
- Linkzary is a **fully client-side** Android app. There is **no backend server** and **no API keys** shipped in the repository.
- The app stores data locally on the device using a Room database.
